...
{
   int Fdiv;
   LPC_UART0->FCR =0x81;  //使能FIFO，设置触发点为8字节
...
void UART0_IRQHandler(void)
{
 ...
 {   
	case 0x04: for(i=0;i<8;i++)  m[i]=LPC_UART0->RBR;  break;                                 //发生RDA中断
	 
    case 0x0c:  while( (LPC_UART0->LSR & 0x01) ==1 ) m[i++]=LPC_UART0->RBR;  break;           //发生CTI中断 
